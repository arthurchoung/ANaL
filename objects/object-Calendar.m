...
+ (id)Calendar
{
    ...
    id object = [Definitions Calendar:year];
    return object;
}
+ (id)Calendar:(int)year
{
    id object = [Definitions Calendar:year columns:3];
    return object;
}
...
- (void)updateEventsArray
{
    ...
    id cmd = nsarr();
    [cmd addObject:@"anal-calendar-listEvents.py"];
